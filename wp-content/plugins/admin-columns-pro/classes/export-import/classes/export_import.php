	...
	public function tab_importexport_contents( $content ) {
							...
							<?php if ( $groups = $this->get_export_multiselect_options() ) : ?>
								<form method="post" action="">
									...
									<div class="submit">
										...
										<input type="submit" class="button button-primary alignright" name="cpac-export-text" value="<?php _e( 'Download export file', 'cpac' ); ?>">
									</div>
								</form>
							<?php else : ?>
		...
		<table class="form-table cpac-form-table">
			<tbody>
				<tr>
					<td>
						<h3><?php _e( 'Download export file', 'cpac' ); ?></h3>
						...
						<ol>
							...
							<li><?php _e( 'Click the &quot;Download export file&quot; button', 'cpac' ); ?></li>
							<li><?php _e( 'Save the .json-file when prompted', 'cpac' ); ?></li>
							<li><?php _e( 'Go to the Admin Columns import/export page in your other installation', 'cpac' ); ?></li>
							<li><?php _e( 'Select the export .json-file', 'cpac' ); ?></li>
							<li><?php _e( 'Click the &quot;Start import&quot; button', 'cpac' ); ?></li>
							<li><?php _e( "That's it!", 'cpac' ); ?></li>
						</ol>
					</td>
					<td>
			...
			<tbody>
				<tr>
					<th scope="row">
						...
						<p><?php _e( 'Import your Admin Column settings here.', 'cpac' ); ?></p>
