...
<section id="resources-container">     
    ...
    <div class="publish-container media-list">    
        ...
        <div class="more-articles-button-container">       
            <input type="submit" id="more-articles-button" class="button" onclick ="getMoreArticles('publish'); return false;" value="<?php _e("Load more articles", "social-resources");?>"/>       
    ...
    <div id="message" class="messageBox note icon">
        <span><?php _e("This user doesn't have any article.", "social-resources");?></span>
    </div>
    <?php endif;?>
</section>     
