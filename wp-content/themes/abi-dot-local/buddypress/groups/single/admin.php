			...
			<ul id="members-list" class="item-list single-line">
				<?php while ( bp_group_members() ) : bp_group_the_member(); ?>
					...
					<li class="<?php bp_group_member_css_class(); ?>">
						...
						<?php echo abi_group_role_editor(bp_get_member_user_id()); ?>
						<input type="hidden" class="abi-meta-user-id" value="<?php echo bp_get_member_user_id(); ?>" />
						<input type="hidden" class="abi-meta-group-id" value="<?php bp_current_group_id(); ?>" />
